...
<div class="shadow p-5 m-5">
    ...
    <div class="form-group">
        ...
        <input class="form-control" name="edit_title" class="py-4" id="edit_title" type="text" />
    </div>
    <div class="form-group">
        <label class="mb-1" for="edit_content">Edit Content</label><br>
        <textarea class="form-control" name="edit_content" id="edit_content" cols="30" rows="10"></textarea>    
    </div>
